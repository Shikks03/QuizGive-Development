...
// Shell pieces: Logo, Sidebar, Topbar, account modal.

const { Plus, Star, StarFill, Search, Settings, Menu, X, Sun, Moon, Sparkles, Book, FileText, Award, Edit } = window.QGIcon;

window.QGLogo = function QGLogo({ size = 19 }) {
  return (
...
// ── Sidebar ──────────────────────────────────────────────────────
window.QGSidebar = function QGSidebar({ state, actions, route, navigate, onClose }) {
...
// ── Topbar ───────────────────────────────────────────────────────
window.QGTopbar = function QGTopbar({ title, subtitle, left, right, onMenu }) {
  return (
